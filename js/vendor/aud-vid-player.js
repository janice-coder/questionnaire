  ...
  (function (e, t) {
    ...
    var I,
      ...
      ne = function (e) {
        ...
        if (!F(e)) return !1;
        var t = e;
        (e.startsWith('https://') && e.startsWith('https://')) ||
          (t = 'https://'.concat(e));
        try {
    ...
    var nt = {
      ...
      createIcon: function (e, t) {
        var i = nt.getIconUrl.call(this),
          ...
          a = document.createElementNS('https://www.w3.org/2000/svg', 'svg');
        de(a, ce(t, { 'aria-hidden': 'true', focusable: 'false' }));
        var s = document.createElementNS('https://www.w3.org/2000/svg', 'use'),
          r = ''.concat(n, '-').concat(e);
        return (
          'href' in s &&
            s.setAttributeNS('https://www.w3.org/1999/xlink', 'href', r),
          s.setAttributeNS('https://www.w3.org/1999/xlink', 'xlink:href', r),
          a.appendChild(s),
          a
        );
      },
